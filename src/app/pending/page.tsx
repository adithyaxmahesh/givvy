      ...
      <div className="relative w-full max-w-lg">
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-200/60 shadow-xl p-8 sm:p-10 text-center">
          ...
          <p className="text-gray-600 mt-3 leading-relaxed">
            Thank you for signing up. Every account on Givvy is reviewed by a person before it is activated. We&apos;re looking at your profile now and will get back to you shortly.
          </p>
