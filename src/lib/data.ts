...
const openRolesNeuralFlow: OpenRole[] = [
  ...
  },
  {
    ...
    category: 'design',
    marketplace_section: 'equity-work',
    work_type: 'project',
    compensation_type: 'blended',
    equity_min: 36000,
    equity_max: 96000,
...
export const mockNotifications: NotificationItem[] = [
  ...
  },
  {
    ...
    description:
      'Your milestone "Launch Multi-Channel Acquisition Strategy" has been approved. $43,750 unlocked.',
    type: 'milestone',
